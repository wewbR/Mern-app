...
const EmailSender = (person, name) => {
  const options = {
    from: "workwonders180@gmail.com",
    to: person,
    subject: "Message From WorkWonders 👨‍💻",
    html: `<!DOCTYPE html
                        ...
                        <tr>
                            <td align="center" style="padding:0;Margin:0">
                                <table bgcolor="#efefef" class="es-content-body" align="center" cellpadding="0"
                                    ...
                                    <tr>
                                        <td align="left" bgcolor="#feab5e"
                                            style="padding:0;Margin:0;padding-top:20px;padding-left:40px;padding-right:40px;background-color:#feab5e">
                                            <table cellpadding="0" cellspacing="0" width="100%"
                                                style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                <tr>
                                                    <td align="center" valign="top"
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="left" style="padding:20px;Margin:0">
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Imprima, Arial, sans-serif;line-height:27px;color:#2D3142;font-size:18px">
                                                                        I am writing this email to acknowledge that we
                                                                        ...
                                                                        are always happy to help.<br><br></p>
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Imprima, Arial, sans-serif;line-height:27px;color:#2D3142;font-size:18px">
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Imprima, Arial, sans-serif;line-height:27px;color:#2D3142;font-size:18px">
                                                                        Best regards,<br><br>Tarik Bouchaala<br><br>CEO
                                                                        of WorkWonders</p>
                                                                </td>
                                                            </tr>
                                                        </table>
                        ...
                        <tr>
                            <td align="center" style="padding:0;Margin:0">
                                <table bgcolor="#bcb8b1" class="es-footer-body" align="center" cellpadding="0"
                                    ...
                                    <tr>
                                        <td align="left" bgcolor="#feab5e"
                                            style="padding:0;Margin:0;padding-left:20px;padding-right:20px;padding-bottom:30px;background-color:#feab5e">
                                            <table cellpadding="0" cellspacing="0" width="100%"
                                                style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                <tr>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Imprima, Arial, sans-serif;line-height:30px;color:#ffffff;font-size:20px">
                                                                        Copyright Work Wonders© 2023 | All Rights
                                                                        Reserved</p>
                                                                </td>
                                                            </tr>
                                                        </table>
